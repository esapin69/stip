(() => {
  ...
  function css(){
    ...
    const l=document.createElement("link");l.rel="stylesheet";l.href="agent-agenda-view.css?v=20260921-aav2";l.dataset.agentAgendaCss="1";document.head.appendChild(l);
  }
