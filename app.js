...
$('#homeBtn')?.addEventListener('click',()=>{setHash('home');showOnly('homeView')});$$('[data-home]').forEach(b=>b.addEventListener('click',()=>{setHash('home');showOnly('homeView')}));
...
window.addEventListener('popstate',restoreRoute);window.addEventListener('hashchange',restoreRoute);window.STIPRouter={set:setHash,restore:restoreRoute,show:showOnly,get:route};
