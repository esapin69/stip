(()=>{'use strict';
const loaded=new Map(),V='20260824-permissions2';
...
const change=['planning-home.js','change-workflow.js','change-permission-gate.js','ui-polish-final.js'];
let busyRoute='';
...
document.addEventListener('pointerdown',e=>{const b=e.target.closest?.('[data-app]');if(!b)return;const k=b.dataset.app;if(k==='responsable'){const l=document.createElement('link');l.rel='prefetch';l.href='/responsable.html';document.head.appendChild(l);return}if(k==='contacts')seq(['section-hubs.js']).catch(()=>{});if(k==='personal')seq(['planning-home.js','planning-month-hero.js']).catch(()=>{});if(k==='team')seq(['planning-home.js','planning-hub-enhance.js']).catch(()=>{});if(k==='change')seq(['planning-home.js','change-workflow.js','change-permission-gate.js']).catch(()=>{})},{passive:true,capture:true});
