(()=>{'use strict';
const loaded=new Map(),V='20260918-monthcontext1';
...
function idle(){if(new URLSearchParams(location.search).has('view_agent'))load('readonly-view-as.js').catch(console.error)}
