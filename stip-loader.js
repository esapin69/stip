(()=>{'use strict';
const loaded=new Map(),V='20260824-compare1';
...
const personal=['planning-home.js','planning-compare.js','planning-month-hero.js','planning-print-reference.js','agent-week-view.js','planning-agenda-extras.js','calendar-subscriptions.js','calendar-responsable-gate.js','day-workflow.js','day-workflow-leave.js','day-workflow-home-bridge.js','signature-success-ui.js'];
...
document.addEventListener('pointerdown',e=>{const b=e.target.closest?.('[data-app]');if(!b)return;const k=b.dataset.app;if(k==='responsable'){const l=document.createElement('link');l.rel='prefetch';l.href='/responsable.html';document.head.appendChild(l);return}if(k==='contacts')seq(['section-hubs.js']).catch(()=>{});if(k==='personal')seq(['planning-home.js','planning-compare.js','planning-month-hero.js']).catch(()=>{});if(k==='team')seq(['planning-home.js','planning-hub-enhance.js']).catch(()=>{});if(k==='change')seq(['planning-home.js','change-workflow.js','change-permission-gate.js']).catch(()=>{})},{passive:true,capture:true});
