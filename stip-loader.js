(() => {
  ...
  const personalCore = [
    "agent-agenda-view.js?v=20260924-month-spacing3",
  ...
  async function ensureRoute(r) {
    ...
    if (r.startsWith("contacts")) {
      ...
      await seq(["agent-agenda-view.js?v=20260924-month-spacing3", "section-hubs.js"]);
  ...
  document.addEventListener(
    ...
    (e) => {
      ...
      if (k === "contacts") {
        window.STIPReadCache?.requestContacts?.();
        seq(["agent-agenda-view.js?v=20260924-month-spacing3", "section-hubs.js"]).catch(() => {});
      }
