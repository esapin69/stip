...
Quand une page est migrée vers le thème, retirer progressivement les anciennes couches devenues inutiles : styles inline, CSS injecté par JavaScript, variantes dupliquées, breakpoints contradictoires, anciens wrappers visuels et composants remplacés.

Une migration réussie doit réduire le nombre de règles concurrentes, pas l'augmenter.
...
Le Planning perso / calendrier est le premier composant de référence migré sous le thème. Sa géométrie sert de précédent : adaptation calculée à la largeur réelle, pas de tailles bricolées pour chaque appareil.
