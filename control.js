...
function status(v){return({open:"À analyser",validated:"Validé",modify_requested:"À modifier",refused:"Refusé",delete_approved:"Suppression validée",executing:"Exécution",done:"Terminé",execution_failed:"Échec",superseded:"Remplacé"})[v]||v}
...
async function openGpt(c,msg){
  ...
  try{
    ...
    const instruction=[
      "Prends en charge ce dossier technique STIP de façon autonome jusqu’à sa clôture.",
      "Ouvre et lis intégralement le dossier temporaire ci-dessous.",
      "Contre-vérifie les faits avec mes connecteurs GitHub, Supabase, Vercel et Google Drive.",
      "Décide toi-même techniquement s’il faut corriger, modifier, refuser ou ne rien faire.",
      "Exécute toi-même les actions sûres, réversibles et testables, puis vérifie le résultat et mets STIP à jour.",
      "Ne me demande pas de choisir entre VALIDER / MODIFIER / REFUSER.",
      "Demande-moi uniquement une confirmation simple si l’action est irréversible ou a une conséquence importante (suppression définitive, coût, domaine critique, perte de données/historique).",
      "Ne me demande jamais de copier-coller une réponse dans STIP.",
      "",
