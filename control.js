...
async function openGpt(c,msg){
  ...
  try{
    ...
    const instruction=[
      "Tu prends en charge ce dossier technique STIP jusqu’à sa clôture.",
      ...
      "Pendant l’analyse, ne modifie rien.",
      "Ensuite pose-moi UNE question de décision simple et factuelle.",
      "Après ma réponse explicite, fais toi-même le nécessaire avec les connecteurs, vérifie le résultat et mets le dossier STIP à jour.",
      "Ne me demande pas de copier-coller une réponse dans STIP.",
      "",
